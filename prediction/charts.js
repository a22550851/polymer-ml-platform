...
function resetWithoutHighlight(data, inputDonor, inputAcceptor, type, chartId) {
    // 重繪圖表並跳過高亮
    plotPropertyGraphs(data, inputDonor, inputAcceptor, type, true, chartId);
}
function resetChart(data, inputDonor, inputAcceptor, type, chartId) {
    // 完全重繪圖表，並包含高亮
...
function plotPropertyGraphs(data, inputDonor, inputAcceptor, type, skipHighlight = false, chartId = null) {
    ...
    const resetWithoutHighlightButton = (chartId) => ({
        name: 'Unmatched',
        icon: Plotly.Icons.undo,
        click: function() {
            resetWithoutHighlight(data, inputDonor, inputAcceptor, type, chartId);
        }
    });

    const resetButton = (chartId) => ({
        name: 'Reset',
        icon: Plotly.Icons.home,
        click: function() {
            resetChart(data, inputDonor, inputAcceptor, type, chartId);
        }
    });
    ...
    if (chartId === null || chartId === 'chartHOMOAcceptor') {
        Plotly.newPlot('chartHOMOAcceptor', [homoaData], homoaLayout, {
            ...
            modeBarButtonsToAdd: [resetWithoutHighlightButton('chartHOMOAcceptor'), resetButton('chartHOMOAcceptor')]
        });
    }
    ...
    if (chartId === null || chartId === 'chartLUMOAcceptor') {
        Plotly.newPlot('chartLUMOAcceptor', [lumoaData], lumoaLayout, {
            modeBarButtonsToRemove: ['zoom2d', 'hoverClosestCartesian', 'select2d', 'lasso2d', 'resetScale2d', 'hoverCompareCartesian', 'toggleSpikelines'],
            modeBarButtonsToAdd: [resetWithoutHighlightButton('chartLUMOAcceptor'), resetButton('chartLUMOAcceptor')]
        });
    }
    ...
    if (chartId === null || chartId === 'chartHOMODonor') {
        Plotly.newPlot('chartHOMODonor', [homodData], homodLayout, {
            modeBarButtonsToRemove: ['zoom2d', 'hoverClosestCartesian', 'select2d', 'lasso2d', 'resetScale2d', 'hoverCompareCartesian', 'toggleSpikelines'],
            modeBarButtonsToAdd: [resetWithoutHighlightButton('chartHOMODonor'), resetButton('chartHOMODonor')]
        });
    }
    ...
    if (chartId === null || chartId === 'chartLUMODonor') {
        Plotly.newPlot('chartLUMODonor', [lumodData], lumodLayout, {
            modeBarButtonsToRemove: ['zoom2d', 'hoverClosestCartesian', 'select2d', 'lasso2d', 'resetScale2d', 'hoverCompareCartesian', 'toggleSpikelines'],
            modeBarButtonsToAdd: [resetWithoutHighlightButton('chartLUMODonor'), resetButton('chartLUMODonor')]
        });
    }
    ...
    if (chartId === null || chartId === 'chartBandgapAcceptor') {
        Plotly.newPlot('chartBandgapAcceptor', [bandgapAcceptorData], bandgapAcceptorLayout, {
            modeBarButtonsToRemove: ['zoom2d', 'hoverClosestCartesian', 'select2d', 'lasso2d', 'resetScale2d', 'hoverCompareCartesian', 'toggleSpikelines'],
            modeBarButtonsToAdd: [resetWithoutHighlightButton('chartBandgapAcceptor'), resetButton('chartBandgapAcceptor')]
        });
    }
    ...
    if (chartId === null || chartId === 'chartBandgapDonor') {
        Plotly.newPlot('chartBandgapDonor', [bandgapDonorData], bandgapDonorLayout, {
            modeBarButtonsToRemove: ['zoom2d', 'hoverClosestCartesian', 'select2d', 'lasso2d', 'resetScale2d', 'hoverCompareCartesian', 'toggleSpikelines'],
            modeBarButtonsToAdd: [resetWithoutHighlightButton('chartBandgapDonor'), resetButton('chartBandgapDonor')]
        });
    }
